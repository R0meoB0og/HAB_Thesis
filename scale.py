# Romain Huet. Code to test on model on green bay images
...
# Now generate predictions with the model trained on lake okee
...
# info: mM1: model_lake_okee_10000, M2: model_compiled_10000

# Define the path to the saved model
model_dir = r"C:\\Users\\rdphu\\OneDrive\\Bureau\\RSM\\Thesis\\saved_models"
model_path = os.path.join(model_dir, 'model_compiled_10000.pt')
...
# info: T1 is lake_okee_2021, T2 is albemarle, (T3M1 is noaa_test & T3M2 is noaa_split\\val)


# Get dataset
path_im = r"C:\\Users\\rdphu\\OneDrive\\Bureau\\RSM\\Thesis\\zeeland\\images"
path_lab = r"C:\\Users\\rdphu\\OneDrive\\Bureau\\RSM\\Thesis\\zeeland\\labels"
test_set = LakeImageSet(path_im, path_lab)
